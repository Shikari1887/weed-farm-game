...
const STRAINS = [
  // TEST SEEDS (FREE - for testing) 🧪
  { id: 999, name: '🧪 Test Seed Fast', cost: 0, sellPrice: 0, growthTime: 10 * 1000, level: 1, tier: 'budget', xp: 1, type: 'balanced' },
  { id: 998, name: '🧪 Test Seed Medium', cost: 0, sellPrice: 0, growthTime: 30 * 1000, level: 1, tier: 'premium', xp: 2, type: 'quality' },
  { id: 997, name: '🧪 Test Seed Slow', cost: 0, sellPrice: 0, growthTime: 60 * 1000, level: 1, tier: 'elite', xp: 5, type: 'quality' },
